<template>
  ...
  <div
    class="h-screen bg-white bg-no-repeat bg-cover flex justify-center items-center"
    ...
    <div class="bg-white w-96 shadow-md rounded px-8">
      ...
      >
        <template v-slot:append>
          <image-verify
            v-model:code="data.verifyCode"
            :height="30"
            @update="refreshVerifyCode"
          />
        </template>
      </el-input>
      <div class="my-4">
        <div class="flex flex-col items-center justify-center">
          <el-button type="success" class="w-full my-2" @click="login"
            >登录</el-button
          >
        </div>
        <!--        <div class="flex flex-col items-center justify-center">-->
